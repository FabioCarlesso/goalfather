...
| `AUTH_REGISTER_MAX_ATTEMPTS` | `10` | Cadastros por `IP` antes do `429`. |
...
> Premissa: **instância única** (contador em memória via Caffeine). Atrás do
> nginx, o IP vem de `X-Forwarded-For`.
